...
public class ClearImageHelper {
	...
	public static void cleanImage(File sfile, String destDir) throws IOException {
		...
		cleanImage(sfile,new File(destDir, sfile.getName()));
		
	}

	
	public static void cleanImage(File sfile, File destfile) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 */
		File testDataDir = new File(Config.imageTmpPath + "test.jpg");// 去噪
		String destDir = Config.imageTmpPath + "test0.jpg";
